...
def solve_two_vcf(sv_dict1, sv_dict2, output):  #vcf1是被比较的
    file = open(output, 'w')
    right = 0
    another = 0
    wrong = 0
...
if __name__ == '__main__':
    ...
    vcf_test = sys.argv[2]
    output = sys.argv[3]
    sv_dict1 = parse_nstd(vcf_standard)
    sv_dict2 = parse_nstd(vcf_test)
    right1, standard_cnt = solve_two_vcf(sv_dict1, sv_dict2, output)
    right2, test_cnt = solve_two_vcf(sv_dict2, sv_dict1, output)
